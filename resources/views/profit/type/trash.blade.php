    ...
    <div class="py-6 w-full min-w-0" dir="{{ app()->getLocale() == 'ku' ? 'rtl' : 'ltr' }}">
        <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4 px-4 no-print">
            <div class="flex items-center gap-3">
                ...
                <h3 class="text-xl font-black text-slate-800 tracking-tight">{{ __('profit.menu_types') }} ({{ __('profit.trash') ?? 'Trash' }})</h3>
            </div>
            
            {{-- FIXED LINK: Changed from profit.index to profit.types.index --}}
